...
public class ChaCha20Poly1305Tests
{
    ...
    public static IEnumerable<object[]> InvalidParameterSizes()
    {
        ...
        yield return new object[] { ChaCha20Poly1305.TagSize, 0, ChaCha20Poly1305.NonceSize + 1, ChaCha20Poly1305.KeySize, ChaCha20Poly1305.TagSize };
        yield return new object[] { ChaCha20Poly1305.TagSize, 0, ChaCha20Poly1305.NonceSize - 1, ChaCha20Poly1305.KeySize, ChaCha20Poly1305.TagSize };
    ...
    public void Decrypt_Tampered(string ciphertext, string plaintext, string nonce, string key, string associatedData)
    {
        ...
        var p = new byte[parameters[0].Length - ChaCha20Poly1305.TagSize];
